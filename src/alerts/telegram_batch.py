"""
Consolidated Telegram Alert System for 30m Analysis
...
def send_consolidated_alert(all_signals, timeframe="30m"):
    """
    Send ONE consolidated message with ALL detected 30m signals
    """
