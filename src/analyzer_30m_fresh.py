...
class Fresh30mAnalyzer:
    def __init__(self):
        ...
        self.deduplicator = FreshSignalDeduplicator(freshness_minutes=10)  # 10 min for 30m
    ...
    def load_market_data(self):
        ...
        # Combine with priority coins first
    ...
    def run_fresh_analysis(self):
        ...
        # Collect FRESH signals only (blocked coins already filtered, major coins prioritized)
        fresh_signals = []
        batch_size = 20
        total_analyzed = 0
